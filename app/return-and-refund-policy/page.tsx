...
import { refundPolicy } from "@/content/data/legal";
import { brand } from "@/brand.config";

export const metadata: Metadata = {
  title: `Return & Refund Policy | ${brand.name}`,
  description: `Return and refund policy for ${brand.name}'s services.`,
};
    ...
    <>
      ...
      <main className="flex-1">
        <LegalHeader
          ...
          description="How refunds and returns are handled for our services."
        />
